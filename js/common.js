	...
	var common = {
		...
		insta: function() {
			...
			const feed = new Instafeed({
				limit: 1000,
				accessToken:
				"IGQVJWYWhra2E3MGVtNW1WRm9vVTQ5NlVaTHZACUnJkZAnFVcTZAyd3NGRGZAlQUhIMHNIVk5fTEJOaUlIYlIyMHduVE1wMXBWeUF0Ml9QMFRNTFR0eW95eXd6NmFCd2owblZAqTl9hYXoxeDk5M29vOU1NbgZDZD",
				target: placeholder,
				template:
